...
def load_playerclasses(world):
  ...
  for playerclass in config.sections():
    ...
    starting_items = config.get(playerclass,'starting_items').split(',')
    ...
    world.playerclasses[playerclass] = PlayerClass(playerclass,title,hp_rate,mp_rate,abilities, starting_items, hit_bonus,arm_bonus,dam_bonus,spi_bonus,weapons_allowed, armor_allowed, sword_bonus, spear_bonus, wand_bonus,staff_bonus,bow_bonus)  

class PlayerClass:

  def __init__(self, name, title, hp_rate, mp_rate, abilities, starting_items, hit_bonus, arm_bonus, dam_bonus, spi_bonus, weapons_allowed, armor_allowed, sword_bonus, spear_bonus, wand_bonus, staff_bonus, bow_bonus):
    '''
